          ...
          <div className="flex gap-3">
            ...
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-green-400 flex-shrink-0">
                <path d="M3.609 1.814a1.56 1.56 0 0 0-.552 1.27v17.832a1.56 1.56 0 0 0 .552 1.27l.065.055 9.99-9.99v-.236L3.674 1.759l-.065.055zM16.99 15.248l-3.327-3.327v-.236l3.326-3.326.076.043 3.937 2.237c1.125.639 1.125 1.685 0 2.324l-3.937 2.237-.076.048zM17.065 15.29l-3.4-3.4-9.992 9.993c.37.391.983.44 1.68.049L17.065 15.29zM17.065 8.316L5.353 1.674C4.657 1.283 4.043 1.332 3.674 1.723l9.99 9.993 3.4-3.4z" />
              </svg>
